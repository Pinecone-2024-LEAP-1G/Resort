              ...
              <DialogHeader>
                ...
                <DialogDescription className="gap-4 p-6 text-gray-900">
                  <div className="flex flex-col gap-4">
                    ...
                    <p>
                      You could be charged for damage, any of your stuff that
                      goes missing, or unexpected cleaning costs due to your
                      stay.
                    </p>
                    <h2 className="text-lg font-medium text-black">
                      the process?
                    ...
                    <p>
                      If you and your Host work it out first, step in to
                      determine responsibility. only charge your payment method
                      if we have reason to believe responsible.
                    </p>
                    <h2 className="text-lg font-medium text-black">
                      What if I agree?
                    </h2>
                    <p>
                      have a chance to appeal if you think we made a mistake.
                    </p>
                  </div>
                </DialogDescription>
              </DialogHeader>
